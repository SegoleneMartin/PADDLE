...
from src.datasets import Tasks_Generator, get_dataset, get_dataloader
#from src.datasets.sampler import CategoriesSampler
from src.datasets.sampler_realistic import CategoriesSampler
import os
...
class Evaluator:
    ...
    def run_full_evaluation(self, model):
        ...
        #torch.save(train_mean, 'train_mean_mini.pt')
        train_mean = torch.load('train_mean_mini.pt')
