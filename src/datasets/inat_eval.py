    ...
    def run_full_evaluation(self, model):
        ...
        for shot in self.args.shots:
            ...
            for i in range(int(self.args.number_tasks/self.args.batch_size)):
                ...
                task_generator = Tasks_Generator(n_ways=n_ways, shot=shot, n_query=self.args.n_query, loader_support=test_loader_support, loader_query=test_loader_query, train_mean=train_mean, log_file=self.log_file)
